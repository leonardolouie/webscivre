...
<form method="POST" action="/superweb/webscivre/public/teacher/update/{{$result->id}}">
   ...
   <div class="form-group col-md-3">
      ...
      <input type="email" class="form-control" id="inputAddress" placeholder="Email" name ="email" value="{{$result->email}}"required>
    </div>
    <div class="form-group col-md-3">

      <label for="inputEmail4">Username</label>
      <input type="text" class="form-control" id="inputAddress" placeholder="username" name ="name" value="{{$result->name}}"required>
    </div>
    <div class="form-group col-md-3">
  ...
  <div class="row">
   ...
   <div class="row">
      <div class="form-group col-md-4">
        <input type="text" class="form-control" id="inputAddress" placeholder="EXAMPLE:XXX-XX" name="id" value="{{$result->id}}"maxlength="12" required>
       </div>

     <div class="form-group col-md-4" >
     <select class="form-control" name="type" value="{{$result->type}}">
  ...
  <div class=" col-md-3">
    ...
    <input type="text" class="form-control" id="inputAddress2" placeholder="Enter Middle Name" name="mname" value="{{$result->middle_name}}" required="">
  </div>
     <div class=" col-md-3">
